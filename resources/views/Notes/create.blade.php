...
@section('content')
    ...
    <a href="{{ route('notes.index') }}" class="bg-blue-500 text-white px-4 py-2 rounded hover:bg-blue-600 mb-4 inline-block">Liste des notes</a>

    <h1 class="text-2xl font-semibold mb-6">Ajouter une nouvelle note</h1>

    <form action="{{ route('notes.store') }}" method="POST" class="max-w-xl mx-auto p-6 bg-white border border-gray-300 rounded shadow-sm">
        @csrf
