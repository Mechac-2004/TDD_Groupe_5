                ...
                @foreach ($etudiants as $etudiant)
                    <tr class="text-center">
                        ...
                        <td class="border border-gray-300 px-4 py-2">
                            ...
                            <a href="{{ route('etudiants.stats', $etudiant) }}" class="bg-blue-500 text-white px-4 py-2 rounded hover:bg-blue-600">Stats générales</a>
                            <a href="{{ route('etudiants.semestre', $etudiant) }}" class="bg-blue-500 text-white px-4 py-2 rounded hover:bg-blue-600">Stats semestrielle</a>
                        </td>
                    </tr>
                @endforeach
            </tbody>
